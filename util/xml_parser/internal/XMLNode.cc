...
indri::xml::XMLNode::XMLNode(const std::string& name, const MAttributes& attributes) : _name(name),
                                                                                       _attributes(attributes) {}

indri::xml::XMLNode::XMLNode(const std::string& name, const MAttributes& attributes,
                             const std::string& value) : _name(name), _attributes(attributes), _value(value) {}
