...
#ifndef THIRD_PART_BINLOG_PARSER_PUBLIC_ROW_OF_FIELDS_H
#define	THIRD_PART_BINLOG_PARSER_PUBLIC_ROW_OF_FIELDS_H
...
#endif	// THIRD_PART_BINLOG_PARSER_PUBLIC_ROW_OF_FIELDS_H
