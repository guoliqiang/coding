...
// Storage structure for the OK package sent from the server to the client.
...
// Storage structure for the Error package sent from the server to the client.
...
void write_packet_header(char *buff, boost::uint16_t size,
...
void prot_parse_error_message(std::istream &is,
                              ...
                              int packet_length);
void prot_parse_ok_message(std::istream &is,
                           struct st_ok_package &ok,
                           int packet_length);
void prot_parse_eof_message(std::istream &is,
