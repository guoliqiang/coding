...
void print_leveln_pntr(FILE *list, const char caption[], struct leveln_pntr *pn)
{
  fprintf(list,"%s%4u/",caption,pn->segment);
  fprintf(list,UINT64_format,pn->block);
}

void print_level0_pntr(FILE *list, struct fcb *f, const char caption[], level0_pntr *p0)
{
...
static void print_lc_key(FILE *list, struct key *k, const char caption[])
{level0_pntr p;
...
static void print_rec_key(FILE *list, struct key *k, const char caption[])
{level0_pntr p;
...
static void print_key_struct(FILE *list, struct key *k, const char caption[])
...
void print_key(FILE *list, int index, struct key *k, const char caption[])
{
