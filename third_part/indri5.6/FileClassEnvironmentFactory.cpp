...
#include "DocumentIteratorFactory.hpp"
...
// static const char* html_conflations[] = { "h1", NULL, NULL, "heading", "h2", NULL, NULL,
// "heading", "h3", NULL, NULL, "heading", "h4", NULL, NULL, "heading", "bloghpno", NULL, NULL, "docno", 0, 0, 0, 0 };
/*
TODO:
...
*/
static const char* html_conflations[] = { "h1", NULL, NULL, "heading",
                                          "h2", NULL, NULL, "heading",
                                          "h3", NULL, NULL, "heading",
                                          "h4", NULL, NULL, "heading",
                                          0, 0, 0, 0 };
static const char* trec_include_tags[] = {"text", "hl", "head", "headline",
                                          "title", "ttl", "dd", "date", "date_time", "lp", "leadpara", 0};
...
static const char* trec_conflations[] = {"hl", NULL, NULL, "headline",
                                         "head", NULL, NULL, "headline",
                                         "ttl", NULL, NULL, "title",
                                         "dd", NULL, NULL, "date",
                                         "date_time", NULL, NULL, "date",
                                         0, 0, 0, 0 };
...
static extension_conflations extensions[] = {_html, _txt, _doc, _ppt, {0} };
...
static void copy_string_tuples_to_map(std::map<indri::parse::ConflationPattern*,std::string>& m, const char** array) {
  if (array) {
    for (unsigned int i = 0; array[i] && array[i + 3]; i += 4) {
      ...
      // value.
      indri::parse::ConflationPattern* key = new indri::parse::ConflationPattern;
...
indri::parse::FileClassEnvironment* build_file_class_environment(const file_class_environment_spec* spec) {
  ...
  env->iterator = indri::parse::DocumentIteratorFactory::get(spec->iterator, spec->startDocTag,
                                                             spec->endDocTag, spec->endMetadataTag);
...
build_file_class_environment(const indri::parse::FileClassEnvironmentFactory::Specification * spec) {
  indri::parse::FileClassEnvironment* env = new indri::parse::FileClassEnvironment;
...
indri::parse::FileClassEnvironmentFactory::getFileClassSpec(const std::string& name) {
  ...
  if (spec) {
    indri::parse::FileClassEnvironmentFactory::Specification* newSpec =
    new indri::parse::FileClassEnvironmentFactory::Specification;
...
indri::parse::FileClassEnvironment* indri::parse::FileClassEnvironmentFactory::get(const std::string& name) {
  ...
  if (spec) return build_file_class_environment(spec);
  return 0;
}
