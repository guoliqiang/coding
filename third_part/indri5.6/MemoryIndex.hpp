...
#include "TermListFileIterator.hpp"
#include "VocabularyIterator.hpp"
...
#include "ReaderLockable.hpp"
#include "WriterLockable.hpp"
...
class MemoryIndex : public Index {
 public:
  ...
  struct term_entry {
    ...
    term_entry(indri::utility::RegionAllocator* allocator) : list(allocator),
                                                             next(0) { }
    void clearMark() {
      next = 0;
    }
