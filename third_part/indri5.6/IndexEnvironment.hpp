...
struct IndexStatus {
  ...
  virtual void operator () (int code, const std::string& documentPath,
                            const std::string& error, int documentsIndexed, int documentsSeen) {
...
class IndexEnvironment {
 ...
 public:
  ...
  // @param parserName The name of the Transformation to use to compute the numeric value of the field.
  // Repository currently recognizes the name NumericFieldAnnotator.
  ...
  void setMetadataIndexedFields(const std::vector<std::string>& forwardFieldNames,
