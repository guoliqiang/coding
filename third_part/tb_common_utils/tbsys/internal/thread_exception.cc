...
namespace tbutil {
ThreadSyscallException::ThreadSyscallException(const char* file,
    int line, int err ): SyscallException(file, line, err) { }
...
ThreadNotStartedException::ThreadNotStartedException(const char* file,
    int line) : Exception(file, line) { }

const char* tbutil::ThreadNotStartedException::_name
...
BadThreadControlException::BadThreadControlException(const char* file,
    int line) : Exception(file, line) { }

const char* tbutil::BadThreadControlException::_name
...
InvalidTimeoutException::InvalidTimeoutException(const char* file, int line, 
    const tbutil::Time& timeout): Exception(file, line), _timeout(timeout) { }

const char* tbutil::InvalidTimeoutException::_name =
