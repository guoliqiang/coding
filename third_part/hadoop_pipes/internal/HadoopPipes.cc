...
class DownwardProtocol {
 public:
  ...
  virtual void setInputTypes(string keyType,
                             string valueType) = 0;
  virtual void runMap(string inputSplit,
                      int numReduces,
                      bool pipedInput)= 0;
  virtual void mapItem(const string& key,
                       const string& value) = 0;
  virtual void runReduce(int reduce,
                         bool pipedOutput) = 0;
